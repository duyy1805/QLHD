  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Field
          label={
            type.moduleKind === "VERSIONED_DOCUMENT"
              ? "Phiên bản"
              : "Phiên bản/file"
          }
        >
          <Input
            name="versionNo"
            placeholder="v1"
            required={type.moduleKind === "VERSIONED_DOCUMENT"}
          />
        </Field>
        <Field label="File">
      ...
      {type.moduleKind === "ASSIGNMENT_DOCUMENT" && (
        <div className="grid gap-4 md:grid-cols-2">
          <Field label="Người thực hiện">
            ...
            >
              <option value="">Không chỉ định - TBP xác nhận</option>
              {users.map((u) => (
